...
[![License](https://img.shields.io/npm/l/package.json.svg?style=flat)](https://github.com/bytejojo/boss-antd/blob/master/LICENSE)
[![Release](https://img.shields.io/github/release/bytejojo/boss.svg?style=flat)](https://github.com/bytejojo/boss/releases/latest)
[![Travis branch](https://travis-ci.org/bytejojo/boss.svg?branch=master)](https://travis-ci.org/bytejojo/boss)
...
- eslint
- @vue/cli ~3
- [ant-design-vue](https://github.com/bytejojo/ant-design-vue) - Ant Design Of Vue 
...
- Clone repo
```bash
git clone https://github.com/bytejojo/boss.git
cd boss
```
...
- **IMPORTANT : About Issue feedback !! when opening Issue read [Issue / PR Contributing](https://github.com/bytejojo/boss/issues/90)**
...
<a href="https://github.com/bytejojo/boss/graphs/contributors"><img src="https://opencollective.com/ant-design-pro-vue/contributors.svg?width=890&button=false" /></a>
